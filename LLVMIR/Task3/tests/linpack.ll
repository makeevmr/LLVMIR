...
define dso_local i32 @main() #0 {
  ...
  %23 = call ptr @r8mat_gen(i32 noundef 201, i32 noundef 200)
  store ptr %23, ptr %2, align 8
  %24 = call noalias ptr @malloc(i64 noundef 1600) #6
  store ptr %24, ptr %4, align 8
  %25 = call noalias ptr @malloc(i64 noundef 800) #6
  store ptr %25, ptr %10, align 8
  %26 = call noalias ptr @malloc(i64 noundef 1600) #6
...
36:                                               ; preds = %33
  ...
  %41 = mul nsw i32 %40, 201
  %42 = add nsw i32 %39, %41
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds double, ptr %38, i64 %43
  %45 = load double, ptr %44, align 8
  %46 = call double @r8_max(double noundef %37, double noundef %45)
...
78:                                               ; preds = %75
  ...
  %97 = call double @llvm.fmuladd.f64(double %91, double %96, double %83)
...
109:                                              ; preds = %67
  %110 = call double @cpu_time()
  store double %110, ptr %18, align 8
  %111 = load ptr, ptr %2, align 8
  %112 = load ptr, ptr %10, align 8
  %113 = call i32 @dgefa(ptr noundef %111, i32 noundef 201, i32 noundef 200, ptr noundef %112)
...
117:                                              ; preds = %109
  ...
  call void @dgesl(ptr noundef %124, i32 noundef 201, i32 noundef 200, ptr noundef %125, ptr noundef %126, i32 noundef %127)
  %128 = call double @cpu_time()
  store double %128, ptr %19, align 8
  %129 = load double, ptr %19, align 8
  %130 = load double, ptr %18, align 8
  %131 = fsub double %129, %130
  %132 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 1
  store double %131, ptr %132, align 8
  %133 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 0
  %134 = load double, ptr %133, align 16
  %135 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 1
  %136 = load double, ptr %135, align 8
  %137 = fadd double %134, %136
  store double %137, ptr %21, align 8
  %138 = load ptr, ptr %2, align 8
  call void @free(ptr noundef %138) #8
  %139 = call ptr @r8mat_gen(i32 noundef 201, i32 noundef 200)
...
163:                                              ; preds = %160
  ...
  %182 = call double @llvm.fmuladd.f64(double %176, double %181, double %168)
...
212:                                              ; preds = %209
  ...
  %231 = call double @llvm.fmuladd.f64(double %225, double %230, double %217)
...
247:                                              ; preds = %244
  ...
  %254 = call double @r8_abs(double noundef %253)
  %255 = call double @r8_max(double noundef %248, double noundef %254)
...
263:                                              ; preds = %260
  ...
  %270 = call double @r8_abs(double noundef %269)
  %271 = call double @r8_max(double noundef %264, double noundef %270)
...
275:                                              ; preds = %260
  %276 = call double @r8_epsilon()
  store double %276, ptr %7, align 8
  %277 = load double, ptr %15, align 8
  %278 = fdiv double %277, 2.000000e+02
  ...
  store double %284, ptr %16, align 8
  %285 = load double, ptr %21, align 8
  %286 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 2
  store double %285, ptr %286, align 16
  %287 = load double, ptr %21, align 8
  %288 = fcmp olt double 0.000000e+00, %287
  br i1 %288, label %289, label %295

289:                                              ; preds = %275
  %290 = load double, ptr %13, align 8
  %291 = load double, ptr %21, align 8
  %292 = fmul double 1.000000e+06, %291
  %293 = fdiv double %290, %292
  %294 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 3
  store double %293, ptr %294, align 8
  br label %297

295:                                              ; preds = %275
  %296 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 3
  store double -1.000000e+00, ptr %296, align 8
  br label %297

297:                                              ; preds = %295, %289
  %298 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 3
  %299 = load double, ptr %298, align 8
  %300 = fdiv double 2.000000e+00, %299
  %301 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 4
  store double %300, ptr %301, align 16
  %302 = load double, ptr %21, align 8
  %303 = load double, ptr %6, align 8
  %304 = fdiv double %302, %303
  %305 = getelementptr inbounds [6 x double], ptr %20, i64 0, i64 5
